...
fda_application_csv_input="-Dfda.application.csv.input=/tutorial-data-in/fda-join-crunch/fda-applications/FDAApplications.txt"
fda_product_csv_input="-Dfda.product.csv.input=/tutorial-data-in/fda-join-crunch/fda-products/FDAProducts.txt"
fda_application_avro_output="-Dfda.application.avro.output=/user/nick/fda-applications-joined"
